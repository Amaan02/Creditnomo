 ...
 * Displays a CREDITNOMO-style popup when a bet is settled (win or loss)
 */
export const SettlementNotification: React.FC = () => {
    const lastResult = useCreditnomoStore(state => state.lastResult);
    const clearLastResult = useCreditnomoStore(state => state.clearLastResult);
