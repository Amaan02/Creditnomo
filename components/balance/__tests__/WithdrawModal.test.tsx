...
describe('WithdrawModal', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    (useCreditnomoStore as unknown as jest.Mock).mockReturnValue(defaultStoreState);
  });
  ...
  describe('Max Button', () => {
    ...
    it('should not set amount when house balance is zero', () => {
      (useCreditnomoStore as unknown as jest.Mock).mockReturnValue({
        ...defaultStoreState,
        houseBalance: 0,
      });
