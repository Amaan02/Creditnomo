...
const steps = [
    {
        ...
        desc: "CreditCoin Testnet performance with non-custodial security. Creditnomo connects your wallet to a high-speed house balance for instant execution without gas lag."
    },
    {
        id: "02",
...
const testimonials = [
    ...
    },
    {
        name: "Kai Zen",
        role: "Algo Developer",
        content: "Migrating to the CREDITNOMO protocol was the best move. Instant house balance settlement solves the on-chain latency issue perfectly for high-frequency binary options.",
        avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop"
    },
    {
        name: "Julian Vane",
        role: "Quant Trader",
        content: "CREDITNOMO's tiered system provides a clear roadmap for traders. The VIP perks and advanced indicators give us a significant edge in these fast-moving rounds.",
        avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=200&auto=format&fit=crop"
    },
    {
        name: "Sarah M.",
        role: "Early Adopter",
        content: "Switching between Bitcoin and Gold predictions within seconds is what makes CREDITNOMO stand out. The multi-asset support is truly elite.",
...
const faqs = [
    {
        ...
        answer: "To ensure millisecond execution, Creditnomo uses a hybrid house balance system. You deposit CTC on CreditCoin Testnet into a non-custodial treasury, which is then reflected in your game balance for instant off-chain betting."
    },
    {
    ...
    },
    {
        ...
        answer: "Yes. All deposits are held in a secure treasury wallet verified on-chain. Withdrawals are processed through the CREDITNOMO protocol, ensuring you maintain ultimate control over your assets."
    }
];
    ...
    return (
        <main className="landing-layout selection:bg-purple-500/30">
            ...
            <footer className="py-24 px-10 border-t border-white/5 bg-black relative z-10 w-full overflow-hidden">
                <div className="huge-footer-logo text-[12vw] opacity-[0.03]">CREDITNOMO</div>
